...
class TestTelegramNotifier(unittest.TestCase):
    ...
    def test_init(self):
        ...
        test_message = notifiers.Message(
            'Test Machine', Result(
    ...
    def test_text(self):
        ...
        up_message = notifiers.Message(
            'Test Machine', Result(
                True, 1, 'Additional message.', 1480000000))
        up_notifier = notifiers.TelegramNotifier(
            up_message, '-1000')
        self.assertEqual(
            up_notifier.text,
        ...
        down_message = notifiers.Message(
            'Test Machine', Result(
                False, 1, 'Msg.', 1480000000))
        down_notifier = notifiers.TelegramNotifier(
            down_message, '-1000')
        self.assertEqual(
            down_notifier.text,
        ...
        down_notifier_with_template = notifiers.TelegramNotifier(
            down_message, '-1000', down_template=down_template)
        self.assertEqual(
            down_notifier_with_template.text,
